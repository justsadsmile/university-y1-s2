...
using Lab2_DoubleCycleList.Views;
using Lab2_DoubleCycleList.Logic;

namespace Lab2_DoubleCycleList
{
    public partial class MainWindow : Window
    {
        ...
        private void UpdateDisplay()
        {
            ...
            else
            {
                ...
                if (polyP != null)
                {
                    if (polyP.Head == null || polyP.Head.Next == polyP.Head)
                    {
                        dgListDisplay.Items.Add(new { Polynomial = "P(x)", Position = "-", Coefficient = "0 (empty)", Power = "-" });
                    }
                    else
                    {
                        DoubleNode<Term> current = polyP.Head.Next!;
                        int pos = 1;

                        while (current != polyP.Head)
                        {
                ...
                if (polyQ != null)
                {
                    if (polyQ.Head == null || polyQ.Head.Next == polyQ.Head)
                    {
                        dgListDisplay.Items.Add(new { Polynomial = "Q(x)", Position = "-", Coefficient = "0 (empty)", Power = "-" });
                    }
                    else
                    {
                        DoubleNode<Term> current = polyQ.Head.Next!;
                        int pos = 1;

                        while (current != polyQ.Head)
                        {
                            dgListDisplay.Items.Add(new
                            {
                                Polynomial = "Q(x)",
        ...
        private void DestroyList_Click(object sender, RoutedEventArgs e)
        {
            ...
            bool bothEmpty = (polyP == null || polyP.Head == null) && (polyQ == null || polyQ.Head == null);
